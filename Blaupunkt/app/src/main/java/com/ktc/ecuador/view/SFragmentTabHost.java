...
public class SFragmentTabHost extends TabHost
    ...
    private onTabPageActiveEvent tabPageActiveEvent;

    public SFragmentTabHost(Context context) {
    ...
    public SFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        if (event.getKeyCode() == KeyEvent.KEYCODE_DPAD_DOWN) {
            if (getCurrentTab() == 1) {
                EventBus.getDefault().post("ktc");
            }
            tabPageActiveEvent.onTagPageActive();
    ...
    public void setTabPageActiveEvent(onTabPageActiveEvent event) {
        this.tabPageActiveEvent = event;
    }
    ...
    protected void onAttachedToWindow() {
        ...
        for (int i = 0, count = mTabs.size(); i < count; i++) {
            ...
            LogcatUtil.e("tab.fragment = " + tab.fragment + "curr = " + currentTag);
    ...
    public void onTabChangedNew(String tabId) {
        onTabChanged(tabId);
        tabPageActiveEvent.onTagPageActive();
    }
    ...
    public void onTabChanged(String tabId) {
        ...
        if (mOnTabChangeListener != null) {
            mOnTabChangeListener.onTabChanged(tabId, tabPosition);
        }
    }

    public interface OnTabChangeListener {
        void onTabChanged(String tabId, int id);
    }

    public interface onTabPageActiveEvent {
        void onTagPageActive();

        void onTagPageInActive();
    }
