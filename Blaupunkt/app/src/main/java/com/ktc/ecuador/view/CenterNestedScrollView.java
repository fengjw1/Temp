 ...
 */
public class CenterNestedScrollView extends FrameLayout implements NestedScrollingParent,
    ...
    int[] viewOnScreenPositions = new int[2];
    ...
    public CenterNestedScrollView(@NonNull Context context) {
        this(context, null);
    }

    public CenterNestedScrollView(@NonNull Context context, @Nullable AttributeSet attrs) {
...
//ktc tag
        ...
        if (nextFocused != null && isWithinDeltaOfScreen(nextFocused, maxJump, getHeight())) {
            Log.v("ktc", "nextFocused != null && isWithinDeltaOfScreen");
            nextFocused.getDrawingRect(mTempRect);
            Log.v("ktc", "mTempRect=" + mTempRect.toString());
            offsetDescendantRectToMyCoords(nextFocused, mTempRect);
//            int scrollDelta = computeScrollDeltaToGetChildRectOnScreen(mTempRect);
            computeScrollDeltaToGetChildRectOnScreenCenter(nextFocused);
            nextFocused.requestFocus(direction);
        } else {
            Log.v("ktc", "nextFocused != null && isWithinDeltaOfScreen  else");
            // no new focus
            int scrollDelta = maxJump;
            Log.v("ktc", "getScrollY=" + getScrollY() + "  scrollDelta=" + scrollDelta);
     ...
     * 焦点view移动到屏幕中央
     */
    private void computeScrollDeltaToGetChildRectOnScreenCenter(View nextFocused) {
        viewOnScreenPositions[1] = 0;//reset value
        nextFocused.getLocationOnScreen(viewOnScreenPositions);
        int dy = viewOnScreenPositions[1] + nextFocused.getHeight() / 2 - screenHeight / 2;
        Log.v("ktc", "dy=" + dy + " getScrollY= " + getScrollY());
        if (dy < 0) {
            ...
            if (dy + getScrollY() > getScrollRange()) {
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(CenterNestedScrollView v, int scrollX, int scrollY,
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            final CenterNestedScrollView nsvHost = (CenterNestedScrollView) host;
